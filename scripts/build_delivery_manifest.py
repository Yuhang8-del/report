...
def main() -> int:
    ...
    important = [
        ...
        root / "CUSTOMER_DEPLOYMENT_AND_USAGE_GUIDE.md",
        root / "CUSTOMER_DEPLOYMENT_AND_USAGE_GUIDE.docx",
        root / "CUSTOMER_DEPLOYMENT_AND_USAGE_GUIDE.pdf",
        ...
        root / "project" / "docs" / "user-guide-chinese-reference.md",
        root / "outputs" / "gui_camera_page_preview.png",
        root / "project" / "requirements-lock.txt",
    ]
    manifest = {
        "delivery_name": "Complete Runnable Semi-Supervised Fruit Detection Project",
